...
| 分類 | 條數 | 明細 |
|------|------|------|
| 📁 全部 Port | 17,551 | [國家列表](regions_json/README.md) |
| 🔒 Port 443 純 IP | 9,985 | [國家列表](regions_json_443/README.md) |
| 🔒 Port 2053 純 IP | 2,176 | [國家列表](regions_json_2053/README.md) |
...
| 🔒 Port 8443 純 IP | 3,720 | [國家列表](regions_json_8443/README.md) |
| ⭐ 優選 ASN | 470 | [列表](regions_json_preferred_asn/README.md) · [整合全部（ip:port#國家）](https://raw.githubusercontent.com/stevendolike/DD/main/regions_json_preferred_asn/_all.txt) · [443 目錄](regions_json_preferred_asn_443/README.md) |
...
| 🌐 ClientIP 為 IPv4 | 5,100 | [國家列表](regions_json_clientip_v4/README.md) |
